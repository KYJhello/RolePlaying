...
public class PlayerMoverCustom : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        Quaternion lookRotation = Quaternion.LookRotation(forwardVec);  //Quaternion.LookRotation(forwardVec * moveDir.x + rightVec * moveDir.x);
